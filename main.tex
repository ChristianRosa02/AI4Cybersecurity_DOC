...
\begin{itemize}
    \item \textit{FGSM, BIM e PGD (Error-Generic con basse perturbazioni):} Per valori di perturbazione ridotti (es. $\epsilon \leq 0.010$), il trasferimento dell'efficacia malevola avviene solo parzialmente.
