...
\textbf{AGGIUNGERE I GRAFICI E L'ANALISI PER PGD (MANCANO I GRAFICI PER MAX ITER 40)}
...
\begin{itemize}
    \item risultati fixed: \textbf{AGGIUNGERE LINK ALLA REPO}
    \item risultati Least Likely: \textbf{AGGIUNGERE LINK ALLA REPO}
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri0_comparative_maxiter_SEC.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri0_iter1_SEC.png}
        \caption{\texttt{max_iter} = 1}
        \label{fig:PGD_iter1}
    \end{subfigure}
    \hfill
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri0_iter5_SEC.png}
        \caption{\texttt{max_iter} = 5}
        \label{fig:PGD_iter5}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri0_iter10_SEC.png}
        \caption{\texttt{max_iter} = 10}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri0_iter20_SEC.png}
        \caption{\texttt{max_iter} = 20}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri0_iter40_SEC.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri1_comparative_maxiter_SEC.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri1_iter1_SEC.png}
        \caption{\texttt{max_iter} = 1}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri1_iter5_SEC.png}
        \caption{\texttt{max_iter} = 5}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri1_iter10_SEC.png}
        \caption{\texttt{max_iter} = 10}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri1_iter20_SEC.png}
        \caption{\texttt{max_iter} = 20}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri1_iter40_SEC.png}
        \caption{\texttt{max_iter} = 40}
        \label{fig:PGD_nri1_iter40}
    \end{subfigure}
    \caption{PGD - Iterazioni a confronto per \texttt{nri} = 1}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri3_comparative_maxiter_SEC.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri3_iter1_SEC.png}
        \caption{\texttt{max_iter} = 1}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri3_iter5_SEC.png}
        \caption{\texttt{max_iter} = 5}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri3_iter10_SEC.png}
        \caption{\texttt{max_iter} = 10}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri3_iter20_SEC.png}
        \caption{\texttt{max_iter} = 20}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri3_iter40_SEC.png}
        \caption{\texttt{max_iter} = 40}
        \label{fig:PGD_nri3_iter40}
    \end{subfigure}
    \caption{PGD - Iterazioni a confronto per \texttt{nri} = 3}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri5_comparative_maxiter_SEC.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri5_iter1_SEC.png}
        \caption{\texttt{max_iter} = 1}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri5_iter5_SEC.png}
        \caption{\texttt{max_iter} = 5}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri5_iter10_SEC.png}
        \caption{\texttt{max_iter} = 10}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri5_iter20_SEC.png}
        \caption{\texttt{max_iter} = 20}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri5_iter40_SEC.png}
        \caption{\texttt{max_iter} = 40}
        \label{fig:PGD_nri5_iter40}
    \end{subfigure}
    \caption{PGD - Iterazioni a confronto per \texttt{nri} = 5}
...
\begin{figure}[H]
    ...
    \makebox[\textwidth][c]{
        \begin{tabular}{cc}
            ...
            \begin{subfigure}[b]{0.55\textwidth}
                \centering
                \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri0_comparative_maxiter_SEC.png}
            ...
            \begin{subfigure}[b]{0.55\textwidth}
                \centering
                \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri1_comparative_maxiter_SEC.png}
            ...
            \begin{subfigure}[b]{0.55\textwidth}
                \centering
                \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri3_comparative_maxiter_SEC.png}
            ...
            \begin{subfigure}[b]{0.55\textwidth}
                \centering
                \includegraphics[width=\textwidth]{PGD_Error_specific/PGD_Targeted_Fixed_nri5_comparative_maxiter_SEC.png}
...
Tuttavia, i risultati empirici estratti dalla \textit{grid search} smentiscono categoricamente questa assunzione, confermando l'osservazione nella modalità \textit{Fixed}. L'introduzione dei riavvii casuali non solo non migliora l'attacco, ma cala l'efficacia offensiva. 
...
La giustificazione geometrica di questo fallimento risiede nella rigorosa limitazione imposta dal \textit{budget} in norma $L_\infty$. Per raggiungere la classe \textit{Least Likely}, l'immagine deve coprire una distanza enorme. L'approccio deterministico sfrutta il 100\% del \textit{budget} spaziale disponibile muovendosi lungo il vettore ottimale calcolato sin dal primo step. Al contrario, PGD impiega il primo sbalzo perturbativo per muoversi in una direzione casuale. Nelle situazioni in cui la distanza dal bersaglio è già "al limite" della tolleranza massima di $\epsilon$, sprecare anche una minima frazione del raggio d'azione per un salto stocastico significa privare l'algoritmo del "carburante" necessario per completare la transizione. L'immagine si ferma a un passo dalla zona di accettazione del target remoto, registrando un fallimento \textit{error-specific}.
...
In conclusione, questa disamina empirica dimostra che, se vincolati a un \textit{budget} rigido, gli algoritmi basati sul segno del gradiente operano al massimo della loro efficienza quando guidati da una discesa pura e ininterrotta (BIM). Per superare le barriere geometriche imposte dai target estremi senza incappare nelle inefficienze della stocasticità, diviene strettamente necessario abbandonare il paradigma del \textit{budget} vincolante, affidandosi ad algoritmi di ottimizzazione continua come Carlini \& Wagner.
